<template>
    <!-- Modal -->
    <div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="Edit Todo" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content bg-transparent">
                <input class="text w-100 mb-3" id="edit-title" placeholder="Title"/>
                <textarea class="w-100" id="edit-body" placeholder="Body"></textarea>
                <button>
                    <slot>
